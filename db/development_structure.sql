...
CREATE TABLE "payments" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "paymentable_id" integer, "amount" decimal(7,2) DEFAULT 0.0, "type" varchar(255), "reference_number" varchar(255), "description" varchar(255), "created_at" datetime, "updated_at" datetime);
...
INSERT INTO schema_migrations (version) VALUES ('20111125235628');