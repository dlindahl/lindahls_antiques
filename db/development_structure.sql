...
CREATE TABLE "ebay_auction_categories" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "category_id" integer, "parent_id" integer, "level" integer, "version" integer, "leaf_category" boolean, "created_at" datetime, "updated_at" datetime);
CREATE TABLE "ebay_auction_categories_ebay_auctions" ("ebay_auction_id" integer, "ebay_auction_category_id" integer);
CREATE TABLE "ebay_auctions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255), "item_number" varchar(255), "listing_status" varchar(255), "time_left" varchar(255), "description" text, "start_price" decimal DEFAULT 0.99, "current_price" decimal DEFAULT 0.99, "reserve_price" decimal, "buy_it_now_price" decimal, "shipping_price" decimal, "antique_id" integer, "primary_category_id" integer, "winner_id" integer, "length" integer, "bids" integer DEFAULT 0, "hit_count" integer DEFAULT 0, "watch_count" integer DEFAULT 0, "reserve_met" boolean DEFAULT 'f', "start_time" datetime, "end_time" datetime, "date_ended" datetime, "created_at" datetime, "updated_at" datetime);
...
INSERT INTO schema_migrations (version) VALUES ('20110517184123');

INSERT INTO schema_migrations (version) VALUES ('20110517191624');
